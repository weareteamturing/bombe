...
const SvgPaperPen = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 24 24" {...props}>
    <g fill="currentColor" clipPath="url(#paper_pen_svg__a)">
      <rect width={16.457} height={20.197} x={3.5} y={1.645} opacity={0.6} rx={1.175} />
      <path
        fillRule="evenodd"
