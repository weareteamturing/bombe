...
const textColor = {
  'text/primary': palette.lavender400,
  'text/accent/blue': palette.blue400,
  'text/accent/green': palette.green400,
...
const bgColor = {
  'bg/secondary': palette.lavender900,
  'bg/secondary/hovered': palette.lavender700,
  'bg/secondary/pressed': palette.lavender700,
  'bg/primary': palette.lavender400,
  'bg/primary/hovered': palette.lavender200,
  'bg/primary/pressed': palette.lavender200,
  'bg/primary/disabled': palette.lavender800,
  ...
  'bg/accent/green/subtlest': palette.green900,
  ...
  'bg/selected/primary': palette.lavender400,
  ...
  'bg/success': palette.green900,
  'bg/success/bold': palette.green400,
...
const iconColor = {
  ...
  'icon/accent/green': palette.green400,
  ...
  'icon/selected/primary': palette.lavender400,
  'icon/selected': palette.gray50,
  'icon/primary/subtle': palette.lavender600,
  'icon/primary': palette.lavender400,
  'icon/primary/bold': palette.lavender200,
  'icon/success': palette.green400,
...
export default aisaacDarkColor;
