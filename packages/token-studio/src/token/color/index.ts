...
const textColor = {
  ...
  'text/loading/subtle': palette.gray500,
  'text/loading/subtlest': palette.gray200,
} as const;
...
const bgColor = {
  ...
  'bg/loading/subtlest': palette.gray100,
  'bg/loading/subtler': palette.gray200,
  'bg/loading/subtle': palette.gray300,
} as const;
